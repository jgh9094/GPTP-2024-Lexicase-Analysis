...
data_dir <- 'Paper_Data/Contradictory-300/'
...
fig = plot_grid(
  ggdraw() + draw_label("Results for contradictory objectives with 200 redundant cases", fontface='bold', size = 24) + p_theme,
  base,
  legend,
  nrow = 3,
...
save_plot(
  filename ="contradictory-300.pdf",
  fig,
  base_width=13,
  base_height=7
)