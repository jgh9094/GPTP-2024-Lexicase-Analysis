...
data_dir <- 'Paper_Data/Contradictory-500/'
...
fig = plot_grid(
  ggdraw() + draw_label("Results for contradictory objectives with 400 redundant cases", fontface='bold', size = 24) + p_theme,
  base,
  legend,
  nrow = 3,
...
save_plot(
  filename ="contradictory-500.pdf",
  fig,
  base_width=13,
  base_height=7
)